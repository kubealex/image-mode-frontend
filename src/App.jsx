...
export default function App() {
  ...
  const masthead = (
    <Masthead style={{ backgroundColor: '#151515' }}>
      <MastheadMain>
        <MastheadBrand>
          <MastheadLogo style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            {redHatLogo}
            <span style={{ color: '#fff', fontSize: '18px', fontWeight: 600 }}>Image Mode Train Service</span>
          </MastheadLogo>
        </MastheadBrand>
      </MastheadMain>
      <MastheadContent>
